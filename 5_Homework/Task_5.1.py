...
def letter_stat(our_str):
    """ Подсчитывает количество вхождений буквы в строку
            :param: our_str - строка
            :return: словарь, где буква: количество вхождений в строку """

    letters_dict = dict.fromkeys(our_str, 0)  # создаем словарь, в котором ключ - это буква, а значение - 0
    for c in our_str:  # разбиваем строку
        letters_dict[c] += 1  # количество повторений буквы записываем в значение словаря
    return letters_dict
