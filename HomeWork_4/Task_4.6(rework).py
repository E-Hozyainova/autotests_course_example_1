...
def create_phone_number(num_tuple):
    ...
    phone = list(num_tuple)  # преобразование кортежа в список для форматирования
    str_phone = ''
    for a in phone:    # переводим список в строку
        str_phone += str(a)

    str_phone = '(' + str_phone[0:3] + ') ' + str_phone[3:6] + '-' + str_phone[6:]  # подгоняем строку под формат
    # телефона
